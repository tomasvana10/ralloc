...
// Because GitHub says the following:
...
// I added two separate icons instead of merging them into one
...
export function GitHubLightLogo(props: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      role="image"
